...
/// </summary>
internal static class OutPutInfo
{
    /// <summary>
    /// 信息提示弹出框
    /// </summary>
    ...
    {
        VS.MessageBox.ShowWarning(msg, EnvVar.Title);
    }
    ...
    public static async Task VsOutPutWindowAsync(string msg, bool clear = false)
    {
        ...
        {
            panel = await VS.Windows.CreateOutputWindowPaneAsync(EnvVar.Title);
